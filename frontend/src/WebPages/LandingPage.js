        ...
        return(
          <div key={company.companyName} className='row m-2'>
            ...
            {company.jobRoles.map((role)=>{
              ...
              return(
                <>
                  <Link to="/exam-details" key={role.jobRole} className='col-md mb-3 text-dark' onClick={(event) => checkLogin(event)}>
                    <JobCard 
